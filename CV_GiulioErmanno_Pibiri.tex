...
\emph{Reference Indexing};
\emph{Locality-Preserving Minimal Perfect Hashing for K-Mers};
\emph{Compressed and Weighted Dictionaries for K-Mers} (BIOINF 2022, WABI 2022);
...
\cvitem{A.Y. 2022/2023}{COMPUTER SCIENCE I - MOD. 1 (code CT0569, 6 CFU), Bachelor Degree in Ingegneria Fisica, Ca’ Foscari University, Italy}

\cvitem{A.Y. 2022/2023}{COMPUTER SCIENCE FOR CULTURAL HERITAGE (code CT0612, 6 CFU), Bachelor Degree in SCIENZE E TECNOLOGIE PER I BENI CULTURALI, Ca’ Foscari University, Italy}

\cvitem{A.Y. 2022/2023}{PROGRAMMING AND LABORATORY-2 (code CT0442, 6 CFU), Bachelor Degree in INFORMATICA, Ca’ Foscari University, Italy}
...
\cvitem{2022}{Jason Fan, Jamshed Khan, Giulio Ermanno Pibiri, and Rob Patro, \emph{Spectrum preserving tilings enable sparse and modular reference indexing}. 2022. BioRxiv, \url{https://www.biorxiv.org/content/10.1101/2022.10.27.513881v1}, pages 13.}

\cvitem{2022}{Giulio Ermanno Pibiri, Yoshihiro Shibuya, and Antoine Limasset, \emph{Locality-Preserving Minimal Perfect Hashing of $k$-mers}. 2022. ArXiv, \url{https://arxiv.org/abs/2210.13097}, pages 17.}
...
\item Minimal Perfect Hash Functions (SIGIR 2021), Locality-Preserving Minimal Perfect Hash Functions
\item K-Mer Dictionaries (BIOINF 2022, WABI 2022)
\end{itemize}
...
\newline
Reference publication: BIOINF 2022, WABI 2022.
}
...
\newline
Reference publication: ArXiv 2210.13097.
}
