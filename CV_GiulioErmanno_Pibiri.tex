...
\item Grant issued on the european project ACCORDION with theme ``Tecniche algoritmiche per compressione, indicizzazione e ricerca di grandi quantità di dati e progettazione di relative librerie software open source'' (Protocollo n. 0000901/2021, 09/03/2021, ISTI 004/2021 - PI).
\end{itemize}
}
...
\cvitem{\href{https://github.com/jermp/pthash}{\textbf{pthash}}}{The \textsf{C++} library used for the experiments in the paper \emph{PTHash: Revisiting FCH Minimal Perfect Hashing}.}
