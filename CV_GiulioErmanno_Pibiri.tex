...
\cvitem{\href{https://github.com/jermp/opt_vbyte}{\textbf{opt\_vbyte}}}{The \textsf{C++} library used for the experiments in the paper \emph{Variable-Byte Encoding is Now Space-efficient Too}.}
