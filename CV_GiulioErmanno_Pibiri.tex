...
\cvitem{Personal page}{\url{https://jermp.github.io}}
...
\cvitem{A.Y. 2022/2023}{Teacher for KNOWLEDGE, INTERACTION AND INTELLIGENT SYSTEMS-2 (2 CFU), PhD Program in Computer Science, Ca' Foscari University, Italy}
...
\cvitem{2023}{Chair of the Workshop on Compression, Text, and Algorithms (WCTA), co-located with SPIRE 2023.}
...
\cvitem{GB 2023}{Sebastian Schmidt, Shahbaz Khan, Jarno Alanko, Giulio Ermanno Pibiri, Alexandru I. Tomescu, \emph{Matchtigs: minimum plain text representation of $k$-mer sets}. 2023. Genome Biology (GBIO), pages 33.
\newline
...
\cvitem{BIOINF 2023}{Giulio Ermanno Pibiri, Yoshihiro Shibuya, and Antoine Limasset, \emph{Locality-Preserving Minimal Perfect Hashing of $k$-Mers}. 2022. Bioinformatics (BIOINF), pages 9.
\newline
Scimago Rating: \textbf{Q1}
\newline
DOI: %\href{}{}
...
\cvitem{AMB 2022}{Giulio Ermanno Pibiri, \emph{On Weighted $k$-mer Dictionaries}. 2023. Algorithms for Molecular Biology (AMB), pages 25.
\newline
...
GGS Rating: \textbf{A++}
\newline
DOI: \href{https://link.springer.com/chapter/10.1007/978-3-031-29119-7_2}{10.1007/978-3-031-29119-7_2}
\newline
ISBN: 9783031291197
}
...
\cvitem{2023}{Jason Fan, Noor Pratap Singh, Jamshed Khan, Giulio Ermanno Pibiri, Rob Patro, \emph{Fulgor: A fast and compact $k$-mer index for large-scale matching and color queries}. 2023. bioRxiv, \url{https://www.biorxiv.org/content/10.1101/2023.05.09.539895v2}, pages 21.}

\cvitem{2023}{Stefano Calzavara, Lorenzo Cazzaro, Giulio Ermanno Pibiri, and Nicola Prezza, \emph{Verifiable Learning for Robust Tree Ensembles}. 2023. ArXiv, \url{https://arxiv.org/abs/2305.03626}, pages 17.}
...
\item Minimal Perfect Hash Functions (SIGIR 2021), Locality-Preserving Minimal Perfect Hash Functions (BIOINF 2023)
\item $k$-Mer Dictionaries (BIOINF 2022, WABI 2022, AMB 2023, GBIO 2023)
\item Colored $k$-mer indexes (bioRxiv 2023)
\end{itemize}
...
\newline
Reference publication: bioRxiv 2023.
}
