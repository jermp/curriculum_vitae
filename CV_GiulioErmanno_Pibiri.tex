...
\cvitem{2020}{Giulio Ermanno Pibiri and Shunsuke Kanda, \emph{Rank/Select Queries over Mutable Bitmaps}. CoRR, \url{http://arxiv.org/abs/2009.12809}, pages 21.}

\cvitem{2020}{Giulio Ermanno Pibiri and Rossano Venturini, \emph{Techniques for Inverted Index Compression}. ACM Computing Surveys (CSUR), pages 35.}

\cvitem{2020}{Giulio Ermanno Pibiri and Rossano Venturini, \emph{Practical Trade-Offs for the Prefix-Sum Problem}. Software: Practice and Experience (SPE), pages 33.}
...
\cvitem{2017}{Giulio Ermanno Pibiri and Rossano Venturini, \emph{Efficient Data Structures for Massive \emph{N}-Gram Datasets}. ACM Conference on Research and Development in Information Retrieval (SIGIR), pages 10.}
...
\cvitem{10/2018 -- 12/2018}{Assistant for \emph{Competitive Programming and Contests, code 645AA}, Master Degree in Computer Science, University of Pisa, Italy}
...
\cvitem{10/2016 -- 12/2016}{Teacher for \emph{Algorithmics and Laboratory - Corso di recupero, code 008AA}, Bachelor Degree in Computer Science, University of Pisa, Italy}
