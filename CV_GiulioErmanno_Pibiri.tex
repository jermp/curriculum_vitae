...
of PCI Mathematical and Computational Biology (https://mcb.peercommunityin.org).}
...
\cvitem{ALGOMB 2024}{Jason Fan, Noor Pratap Singh, Jamshed Khan, Giulio Ermanno Pibiri, Rob Patro, \emph{Fulgor: A fast and compact $k$-mer index for large-scale matching and color queries}. 2024. Algorithms for Molecular Biology (ALGOMB), 21 pages.
\newline
