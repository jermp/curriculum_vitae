...
Succinct and Dynamic Ordered Sets;
...
\cvitem{2021}{Giulio Ermanno Pibiri and Shunsuke Kanda, \emph{Rank/Select Queries over Mutable Bitmaps}. Information Systems (INFOSYS), pages 15.
\newline
...
\cvitem{2021}{Andrea Bruno, Franco Maria Nardini, Giulio Ermanno Pibiri, Roberto Trani, and Rossano Venturini, \emph{TSXor: A Simple Time Series Compression Algorithm}.
...
\cvitem{07/2021}{\emph{PTHash: Revisiting FCH Minimal Perfect Hashing}. SIGIR conference presentation. Virtual event.}

\cvitem{04/2021}{\emph{Compressed Indexes for Fast Search of Semantic Data}. ICDE conference presentation. Virtual event.}

\cvitem{03/2021}{\emph{Fast and Compact Set Intersection through Recursive Universe Partitioning}. DCC conference presentation. Virtual event.}

\cvitem{04/03/2021}{\emph{Efficiency for Real-World Applications}. Seminar. ISTI-CNR. Virtual event.}
...
\cvitem{2021}{Member of the Program Committee of the 15th IEEE International Conference on Application of Information and Communication Technologies (AICT 2021).}

\cvitem{2021}{Member of the Program Committee of the 30-th ACM International Conference on Information and Knowledge Management (CIKM 2021).}

\cvitem{2021}{Member of the Program Committee of the 44-th ACM International SIGIR Conference on Research and Development in Information Retrieval (SIGIR 2021).}
...
\cvitem{2020}{Member of the Program Committee of the 29-th ACM International Conference on Information and Knowledge Management (CIKM 2020).}
...
\cvitem{2020}{Member of the Program Committee of the 43-rd ACM International SIGIR Conference on Research and Development in Information Retrieval (SIGIR 2020).}

\cvitem{2019}{Member of the Program Committee of the 42-nd ACM International SIGIR Conference on Research and Development in Information Retrieval (SIGIR 2019).}
...
\cvitem{2018}{Member of the Program Committee of the 2-nd Workshop on Knowledge Graphs and Semantics for Text Retrieval and Analysis (KG4IR), in conjuction with ACM SIGIR 2018.}

\cvitem{2017}{Member of the Organizing Committee of the 24-th International Symposium on String Processing and Information Retrieval (SPIRE 2017).}

\cvitem{2016}{Student volunteer for the organization of the 39-th ACM International SIGIR Conference on Research and Development in Information Retrieval (SIGIR 2016).}
