...
\begin{itemize}
    ...
    \item JEA -- Journal of Experimental Algorithmics
    \item Algorithmica
    \item MDPI Algorithms
    \item IEEE TIFS – Transactions on Information Forensics and Security
    \item IPM -- Information Processing and Management
\end{itemize}
}

\section{Editorial Service}

\cvitem{2024 -- present}{I am member of the editorial board of \href{https://www.sciencedirect.com/journal/information-systems/about/aims-and-scope}{\emph{Information Systems}}.}{https://doi.org/10.1016/S0306-4379(24)00031-0}

\cvitem{2024 -- present}{I am member of the editorial board of \href{https://link.springer.com/journal/10791/aims-and-scope}{\emph{Discover Computing}} (formerly known as ``Information Retrieval Journal''.}{https://link.springer.com/journal/10791/editors}

\cvitem{2024 -- present}{I serve as a recommender (similar to an editor)
of PCI \href{https://mcb.peercommunityin.org}{\emph{Mathematical and Computational Biology}}.}{https://mcb.peercommunityin.org/about/recommenders}
...
International Conference on Research in Computational Molecular Biology (RECOMB), \red{XX} pages.
\newline
DOI: \href{}{}
\newline
ISBN:
